...
export class MarcaService {
     ...
     */
    public apiV2MarcaGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe?: 'body', reportProgress?: boolean): Observable<MarcaDtoPaginatedResult>;
    public apiV2MarcaGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<MarcaDtoPaginatedResult>>;
    public apiV2MarcaGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<MarcaDtoPaginatedResult>>;
    public apiV2MarcaGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
    ...
    public apiV2MarcaIdDelete(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiV2MarcaIdDelete.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV2MarcaIdGet(id: number, observe?: 'body', reportProgress?: boolean): Observable<MarcaDto>;
    public apiV2MarcaIdGet(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<MarcaDto>>;
    public apiV2MarcaIdGet(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<MarcaDto>>;
    public apiV2MarcaIdGet(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiV2MarcaIdGet.');
        }
