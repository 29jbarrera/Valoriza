...
@Injectable()
export class GruposCentroService {
     ...
     */
    public apiV2GruposCentroGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe?: 'body', reportProgress?: boolean): Observable<GruposCentroDtoPaginatedResult>;
    public apiV2GruposCentroGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GruposCentroDtoPaginatedResult>>;
    public apiV2GruposCentroGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GruposCentroDtoPaginatedResult>>;
    public apiV2GruposCentroGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
    ...
    public apiV2GruposCentroIdDelete(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiV2GruposCentroIdDelete.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV2GruposCentroIdGet(id: number, observe?: 'body', reportProgress?: boolean): Observable<GruposCentroDto>;
    public apiV2GruposCentroIdGet(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GruposCentroDto>>;
    public apiV2GruposCentroIdGet(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GruposCentroDto>>;
    public apiV2GruposCentroIdGet(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiV2GruposCentroIdGet.');
        }
