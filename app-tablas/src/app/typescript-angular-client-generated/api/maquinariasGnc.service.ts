...
import { MaquinariasGncDto } from '../model/maquinariasGncDto';
...
@Injectable()
export class MaquinariasGncService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV2MaquinariasGncIdGet(id: number, observe?: 'body', reportProgress?: boolean): Observable<MaquinariasGncDto>;
    public apiV2MaquinariasGncIdGet(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<MaquinariasGncDto>>;
    public apiV2MaquinariasGncIdGet(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<MaquinariasGncDto>>;
    public apiV2MaquinariasGncIdGet(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiV2MaquinariasGncIdGet.');
        }
        ...
        return this.httpClient.request<MaquinariasGncDto>('get',`${this.basePath}/api/v2/maquinariasGnc/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
