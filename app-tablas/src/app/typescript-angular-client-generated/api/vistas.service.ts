...
import { ValorizaTypeDtoPaginatedResult } from '../model/valorizaTypeDtoPaginatedResult';
...
export class VistasService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV2ValorizaTypeGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe?: 'body', reportProgress?: boolean): Observable<ValorizaTypeDtoPaginatedResult>;
    public apiV2ValorizaTypeGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ValorizaTypeDtoPaginatedResult>>;
    public apiV2ValorizaTypeGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ValorizaTypeDtoPaginatedResult>>;
    public apiV2ValorizaTypeGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<ValorizaTypeDtoPaginatedResult>('get',`${this.basePath}/api/v2/ValorizaType`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
