...
import { AmortizacionHistoricoDto } from '../model/amortizacionHistoricoDto';
import { AmortizacionHistoricoDtoPaginatedResult } from '../model/amortizacionHistoricoDtoPaginatedResult';
import { CreateAmortizacionHistoricoDto } from '../model/createAmortizacionHistoricoDto';
import { ProblemDetails } from '../model/problemDetails';
import { UpdateAmortizacionHistoricoDto } from '../model/updateAmortizacionHistoricoDto';
...
@Injectable()
export class AmortizacionHistoricoService {
     ...
     */
    public apiV2AmortizacionHistoricoGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe?: 'body', reportProgress?: boolean): Observable<AmortizacionHistoricoDtoPaginatedResult>;
    public apiV2AmortizacionHistoricoGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<AmortizacionHistoricoDtoPaginatedResult>>;
    public apiV2AmortizacionHistoricoGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<AmortizacionHistoricoDtoPaginatedResult>>;
    public apiV2AmortizacionHistoricoGet(Q?: string, sort?: string, page?: number, pageSize?: number, filters?: { [key: string]: string; }, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
    ...
    public apiV2AmortizacionHistoricoIdDelete(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiV2AmortizacionHistoricoIdDelete.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV2AmortizacionHistoricoIdGet(id: number, observe?: 'body', reportProgress?: boolean): Observable<AmortizacionHistoricoDto>;
    public apiV2AmortizacionHistoricoIdGet(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<AmortizacionHistoricoDto>>;
    public apiV2AmortizacionHistoricoIdGet(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<AmortizacionHistoricoDto>>;
    public apiV2AmortizacionHistoricoIdGet(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiV2AmortizacionHistoricoIdGet.');
        }
