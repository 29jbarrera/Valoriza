...
export class GruasDocService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV2GruasDocIdDelete(id: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public apiV2GruasDocIdDelete(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public apiV2GruasDocIdDelete(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public apiV2GruasDocIdDelete(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiV2GruasDocIdDelete.');
        }
        ...
        return this.httpClient.request<any>('delete',`${this.basePath}/api/v2/gruasDoc/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV2GruasDocIdGet(id: number, observe?: 'body', reportProgress?: boolean): Observable<GruasDocDto>;
    public apiV2GruasDocIdGet(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GruasDocDto>>;
    public apiV2GruasDocIdGet(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GruasDocDto>>;
    public apiV2GruasDocIdGet(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling apiV2GruasDocIdGet.');
        }
        ...
        return this.httpClient.request<GruasDocDto>('get',`${this.basePath}/api/v2/gruasDoc/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
